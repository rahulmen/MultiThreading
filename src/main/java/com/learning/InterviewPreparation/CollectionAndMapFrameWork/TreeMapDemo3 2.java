...
public class TreeMapDemo3 {
    ...
    private static com.sun.istack.internal.logging.Logger logger = com.sun.istack.internal.logging.Logger.getLogger(MyComparator5.class);
    ...
    public void testTreeMapUsingDefaultSorting(){
        ...
        logger.info("Map default value :"+map);
    ...
    public void testTreeMapUsingCustomisedSorting(){
        ...
        logger.info("Map Customised value :"+map1);
